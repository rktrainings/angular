...
import SampleFormatDownload from '../../../../assets/data/approval-center/sample-for-board.json'
import { ExcelService } from 'src/app/services/excel.service';
import { NotificationService } from 'src/app/services/notification.service';

@Component({
  selector: 'app-upload-for-board',
  templateUrl: './upload-for-board.component.html',
  styleUrls: ['./upload-for-board.component.scss']
})
export class UploadForBoardComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<UploadForBoardComponent>,
