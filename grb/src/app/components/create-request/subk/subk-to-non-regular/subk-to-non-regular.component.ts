...
@Component({
  selector: 'app-subk-to-non-regular',
  templateUrl: './subk-to-non-regular.component.html',
  styleUrls: ['./subk-to-non-regular.component.scss']
})
export class SubkToNonRegularComponent implements OnInit {
  ...
  onSubmit() {
    this.navigateExternalGRB();
  }

  navigateExternalGRB() {
    ////console.log('navigateExternalGRB');
