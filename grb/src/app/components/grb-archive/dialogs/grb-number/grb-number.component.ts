...
@Component({
  selector: 'app-grb-number',
  templateUrl: './grb-number.component.html',
  styleUrls: ['./grb-number.component.scss'],
  animations: [
...
export class GrbNumberComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<GrbNumberComponent>,
